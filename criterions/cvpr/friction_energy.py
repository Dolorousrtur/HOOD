...
@dataclass
class Config:
    weight: float = 1.              # weight of the criterion
    g: float = 9.81                 # gravity constant
    mu: float = 1.                  # friction coefficient
    friction_radius: float = 5e-3   # maximal distance between cloth and obstacle for friction to be applied
